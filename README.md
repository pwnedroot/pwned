...
4- PHONECHECK_DISCORDBOT.PY (PYTHON0- A DISCORD BOT THAT USES CURL AND AN API KEY TO FETCH INFO ON A PHONE NUMBER, DISCORD API KEY AND PHONEAPI KEY NEEDED, AS WELL AS CHECKPHONE_FOR_PHONECHECK_BOT.SH (MEANT TO RUN ON LINUX)
...
9- DISK_DESTORYER.SH (BASH)- SCRIPT USED TO OVERWRITE THE CONTENTS OF A DRIVE/USB WITH 1'S AND 0'S THREE TIMES TO DELETE ALL DATA

10- ENCRYPT_DECRYPT.PY (PYTHON)- SCRIPT USED TO ENCRYPT/DECRYPT A FILE WITH A PASSWORD INPUTTED BY USER, GOOD FOR SENDING FILES OVER THE INTERNET, (THE PERSON RECIEVING WILL NEED THE SCRIPT AS WELL AS YOUR ENCRYPTION PASSCODE IN ORDER TO DECRYPT)
